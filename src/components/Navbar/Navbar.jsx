...
import { Users, PlaySquare, Video, FileText, User, BookOpen, BrainCircuit } from 'lucide-react';
    ...
    return (
        <div className="navbar-container">
            <nav className="navbar glass">
                ...
                <NavLink to="/conference" title={t.conference} className={({ isActive }) => isActive ? "nav-item active" : "nav-item"}>
                    <Video size={24} />
                </NavLink>
                ...
                <NavLink to="/memory-refresh" title={t.memory_refresh} className={({ isActive }) => isActive ? "nav-item active" : "nav-item"}>
